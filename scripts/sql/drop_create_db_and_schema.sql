-- Trinity Oil Mills - DROP database, CREATE database, then full schema
-- WARNING: This deletes the entire database and all data. Use only for fresh install.
-- Run on server: mysql -u USER -p < drop_create_db_and_schema.sql
-- Replace trinityoil_oil_shop_db_new with your database name if different.
